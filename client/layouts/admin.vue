<template>
    <LoadingSpinner :isActive="state.isPageLoading">
        ...
        <div class="lg:pl-72">
            ...
            <div class="mt-4 px-4 sm:px-6 lg:px-8 flex justify-end">
                <button @click="navigateTo('/admin/students/add')" class=" bg-sky-500 hover:bg-sky-700 text-white font-bold py-2 px-4 rounded ">
                    Add Student
                </button>
            </div>
